QUESTIONS = [{'Question': 'Why do we use methods?',
...
def test():
    ...
    print(QUESTIONS[0]['Answer_1'])
    print(QUESTIONS[0]['Answer_2'])
    print(QUESTIONS[0]['Answer_3'])
    print(QUESTIONS[0]['Answer_4'])
    while input() != QUESTIONS[0]['Right']:
